...
import { layBaiViet, layCay, layModule } from '@/lib/nguon';
...
import { TEN_LOAI, TEN_TRANG_THAI_ND, type Nut, type PhamVi } from '@/types/kho';
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
        ...
        <Button size="sm" disabled={!suaDuoc}>
      ...
      {data && (
        <div className="grid gap-5 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            {chon ? <BangSua nut={chon} suaDuoc={suaDuoc} /> : (
...
function BangSua({ nut, suaDuoc }: { nut: Nut; suaDuoc: boolean }) {
  ...
  return (
    <The className="space-y-1">
      ...
      <div className="flex gap-2 pt-3">
        <Button size="sm" disabled={!suaDuoc}>Sửa</Button>
        <Button size="sm" variant="vien" disabled={!suaDuoc}>Đổi phạm vi</Button>
      </div>
